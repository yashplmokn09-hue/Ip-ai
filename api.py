...
from ip_ai.generate import generate as model_generate, stream as model_stream
from tools.dispatcher import maybe_run_tool, SYSTEM_PROMPT
...
@app.get("/v1/tools")
def list_tools():
    from tools.web_tools import TOOL_SCHEMAS
